...
// softquake -- Remove _WIN32 option count (was 14)
...
void M_AdjustSliders (int dir)
{
	...
	case 5:	// mouse speed
		...
		break;
	case 6:	// music volume
	// softquake -- Don't need this ifdef anymore with SDL_mixer
#if defined _WIN32 && !defined SOFTQUAKE_COMPAT
...
// #ifndef	_WIN32
// softquake -- Used in all cases now
char *quitMessage [] = 
{
/* .........1.........2.... */
  "  Are you gonna quit    ",
...
void M_Quit_Draw (void)
{
	...
	// softquake -- Ending message
	// Make this behaviour adjustable with a cvar
	if (!cl_quitmessage.value)
	{
...
void M_Draw (void)
{
	...
	if (!m_recursiveDraw)
	{
		...
		{
			Draw_FadeScreen (); // softquake -- Todo: Restore the dos menu background
		}
