...
// TODO: collect 386-specific code in one place
	...
	// softquake -- Common cvars between SoftQuake and GLQuake
	R_RegisterCommonCvars();
}
...
/*
================
R_BeginLightmapRender
================
*/
static int r_original_palette = 0;
void R_BeginLightmapRender ()
{
	int i;
	unsigned char monochrome[256*3];
	...
	VID_SetPalette(monochrome);
	r_original_palette = 0;
}

void R_EndLightmapRender ()
{
	if (!r_lightmap.value || r_fullbright.value)
	{
		if(!r_original_palette)
		{
			r_original_palette = 1;
