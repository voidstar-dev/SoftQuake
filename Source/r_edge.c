...
// FIXME: do we need this now that we clamp x in r_draw.c?
	...
	// softquake -- This is the same value as (2000 << 24), and it fixes a compiler warning about overflow.
	// Not sure if this breaks anything. Feel free to restore the old path if needed.
	edge_sentinel.u = 0xd0000000;
